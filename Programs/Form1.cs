...
namespace Programs
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e) //Tempo de Simulação
        {
            tSimulacao++;
        ...
        private void timer2_Tick(object sender, EventArgs e) //Tempo de Processos
        {
            tprocesso++;
        ...
        private void timer3_Tick(object sender, EventArgs e) //Tempo do Buffer
        {
            tBuffer++;
